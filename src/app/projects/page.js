  ...
  export default function Projects() {
    ...
    const projectList = [
      {
        ...
        description: "Building strong, heavy-duty roads designed to last for years under heavy city traffic."
      },
      {
        ...
        description: "Adding high-quality protective layers to roofs to stop water leakage and prevent dampness."
      },
      {
        title: "Waterproofing of swimming pools",
        category: "Specialized Sealing",
        location: "Lucknow Stadium",
        image: "/Waterproofing of swimming pools.jpeg",
        icon: <Waves size={20} />,
        description: "Expert chemical sealing for pools to ensure they remain 100% leak-proof and structurally safe."
      },
      {
        title: "Acp glazing structures and almunium works",
        category: "External Finishing",
        location: "Project Sites",
        image: "/Acp glazing structures and almunium works.jpg",
        icon: <Building size={20} />,
        description: "Installing modern glass fronts and aluminum structures to give buildings a sleek, modern look."
      },
      {
        ...
        icon: <Waves size={20} />,
        description: "Building technical plants that clean waste water so it can be reused safely."
      },
      {
        ...
        description: "Constructing massive, high-elevation concrete tanks to provide water to local communities."
      },
      {
      ...
      },
      {
        ...
        icon: <Layout size={20} />,
        description: "Creating smart spatial layouts to make the best use of indoor office and home areas."
      },
      {
        title: "Architectural and Structural Drawings for Construction Projects",
    ...
    return (
      <main className="bg-white overflow-hidden font-sans selection:bg-orange-100 selection:text-orange-900">
                ...
                <div className="relative z-20 text-center px-6 max-w-4xl">
                  ...
                  >
                    <h1 className="text-3xl md:text-5xl font-serif text-white mb-6 leading-tight tracking-tight uppercase">
                      Our <span className="text-orange-500 ">Work History.</span>
                    </h1>
                    <p className="text-xs md:text-sm text-gray-300 leading-relaxed max-w-lg mx-auto uppercase tracking-widest">
                      Showcasing the technical excellence and precision of Bandhu Enterprises across every project.
                    </p>
                  </motion.div>
                </div>
              </section>
        ...
        <section className="py-32 px-8 lg:px-24 max-w-[1400px] mx-auto">
          ...
          >
            {projectList.map((project, index) => {
              ...
              const centerClass = isLastItem ? "lg:col-start-2" : "";

              return (
                <motion.div 
                  key={index} 
                  variants={fadeInUp}
                  className={`group cursor-default ${centerClass}`}
                >
                  ...
                  <div className="px-4">
                    ...
                    <p className="text-gray-600 text-[14px] leading-relaxed border-l-2 border-orange-500/20 pl-5">
                      {project.description}
                    </p>
                  </div>
                </motion.div>
        ...
        <section className="pb-32 px-8 bg-[#FAFAFA] border-t border-gray-100">
          <motion.div 
