        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
            ...
            >
              ...
              <motion.p variants={fadeInUp} className="text-lg text-[#5C534E] leading-relaxed mb-8">
              ...
              <motion.div variants={staggerContainer} className="grid grid-cols-2 gap-10 border-t border-[#E5E1C9] pt-10">
                <motion.div variants={fadeInUp} className="group cursor-default">
                  <h4 className="font-bold text-3xl md:text-5xl text-[#2D241E] group-hover:text-[#D4AF37] transition-colors duration-500">
                    <Counter value="24" />+
                  </h4>
                  <p className="text-[#8B837E] text-[12px] uppercase tracking-[0.2em] font-bold mt-2">
                    Years of Excellence
                  </p>
                </motion.div>
                <motion.div variants={fadeInUp} className="group cursor-default">
            ...
            >
              <div className="relative z-10 group overflow-hidden rounded-2xl shadow-2xl">
                <img 
                  ...
                  className="w-full aspect-[4/3] object-cover transition-all duration-1000 group-hover:scale-110"
              ...
              <motion.div 
                ...
                className="absolute -bottom-8 -left-8 w-64 h-64 bg-[#D4AF37]/20 rounded-2xl -z-10 hidden md:block" 
              />
            </motion.div>
          </div>
        </div>
